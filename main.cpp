...
Description: This program collects user inputs and validates if they enter the correct input.
             ...
             This program also shows use of class templates and operator overloading.
...
class DynamicArray {
    ...
    public:
        ...
        const Type* operator[] (int index) const{
            if (index < 0 || index >= currentSize) {
                cout << "Index out of bounds. Return a null pointer." << endl;
                return nullptr;
            }
            return array[index];
        }
...
// For Unit Testing
    ...
    TEST_CASE("DynamicArray [] invalid index returns nullptr") {
        DynamicArray<Person> arr;
